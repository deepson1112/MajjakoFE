...
export function PercentOff() {
  ...
  const handleNewOffer = (data: PercentOffType) => {
    ...
    formData.append(
      ...
      `${!!data.maximum_redeem_value ? data.maximum_redeem_value : ""}`
    );
                                ...
                                <FormControl>
                                  <div className="relative">
                                    <Input
                                      ...
                                      {...field}
                                      className="bg-gray-100 border-none pl-10"
                                    />
                                    <div className="absolute top-0 left-0 bg-gray-200 h-full w-8 flex items-center justify-center rounded-l-md">
                                      Rs.
                                    </div>
                                  </div>
                                </FormControl>
