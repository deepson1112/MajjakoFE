...
export function SpecialRequestWishlist({
  handleAddProductToWishlistWithSpecialRequest,
  handleAddProductToWishlistLoader,
  children,
  ...
  handleAddProductToWishlistLoader?: boolean;
  ...
  const handleSpecialRequest = (request: string) => {
    if (!!defaultRequest?.length) {
      ...
      if (handleAddProductToWishlistWithSpecialRequest) {
        handleAddProductToWishlistWithSpecialRequest(request.trim());
      }
    }
  };
